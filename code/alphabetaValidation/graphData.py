...
if __name__ == "__main__":
    ...
    result = {
        ...
        "false": ['Abraham Lincoln', 'Administration', 'Ady Barkan', 'America', 'Americans', 'Amy Sherman', 'Andrew Cuomo', 'Andy Nguyen', 'Animal Agriculture', 'Antibodies', 'Asylum', 'Australia', 'Baltimore', 'Barack Obama', 'Barkan', 'Bernie Sanders', 'Biden', 'Biden Promise Tracker', 'Bill', 'Bill Gates', 'Bill Mccarthy', 'Breast Cancer', 'Burgess Owens', 'California', 'Careers', 'Charles Schumer', 'Chicago', 'Chicago Tribune', 'Children', 'China', 'Chinese', 'Christian Leaders', 'Christian Mcwhirter', 'Church Services', 'Church-Goers', 'Churches', 'Cities', 'Clean Energy Infrastructure', 'Clinicians', 'Communists', 'Community Policing', 'Congress', 'Contact Tracing', 'Cornell', 'Cornell Law School', 'Coronavirus', 'Coronavirus Pandemic', 'Corporate Income', 'Corrections', 'Court Staff',  'Covid-19', 'Crime', 'Curve', 'Cyber Attacks', 'Dan Brouillette', 'David Menchetti', 'Defense Department', 'Democratic Party', 'Democratic Primary Debate', 'District Of Columbia', 'Domestic Policy', 'Donald', 'Donald J. Trump', 'Donald Trump', 'Donate', 'Donations', 'Dtap', 'Electrical Grids', 'Electronic Systems', 'Empire', 'Enewspaper', 'Entertainment', 'Environment', 'Ethical Principles', 'European Union', 'Facebook Posts', 'Fascists', 'Fbi', 'Fda', 'Federal Funding', 'Federal Government', 'Federal Register', 'Federal Spending', 'Feedback', 'Flipboard', 'Florida',  'Foreign Threats', 'Forever', 'Fort Mchenry', 'Fossil Fuels', 'Fracking', 'Funding', 'Gates Connection', 'Gates Foundation', 'Gavi', 'Georgia', 'Germany', 'Government', 'Governors', 'Govtrack', 'Gowns', 'Greenville, Mississippi', 'Gross Domestic Product', 'Guns', 'Health Care', 'Health Centers', 'Health Crisis', 'Help Center', 'Hepatitis A', 'Hepatitis B', 'Her', 'Home Delivery', 'Hospitals', 'House', 'Housing', 'Hpv', 'Hugh Hewitt', 'Human Trafficking', 'Human Trafficking Victims', 'Humanitarian Needs', 'Hydraulic Fracturing', 'Illegal Immigrants', 'Illinois', 'Immigrants', 'Immigration', 'Immigration Cases', 'Immigration Judges', 'Immigration Officials', 'Immigration Plan', 'Immunization Action Coalition', 'In-Person Learning', 'Indiana', 'Influenza', 'Infrastructure Bill', 'Intelligence Community', 'Internet Servers', 'Internships', 'Interpreters', 'Iowa', 'Iran', 'Isolation', 'Italy', 'J. Trump', 'James Madison', 'Janet Yellen', 'Japan', 'Joe', 'Joe Biden', 'John Velazquez', 'Jon Greenberg', 'Joni Ernst', 'Justice Department', 'Kaiser Health News', 'Kamala', 'Kamala Harris', 'Karen Pence', 'Kasim Reed', 'Kayleigh Mcenany', 'Kentucky Derby', 'Kristi Noem', 'Larry Hogan', 'Law Enforcement', 'Lawful Permanent Residents', 'Lebron James', 'Legal Action', 'Legislatures', 'Licensing & Reprints', 'Life', 'Lincoln', 'Linkedin', 'Liquor Stores', 'Local Business News', 'Local Governments', 'Louis Jacobson', 'Madison', 'Maricopa County', 'Marijuana', 'Marsha Blackburn', 'Maryland', 'Mayo Clinic', 'Mayor Errick D. Simmons', 'Mayors', 'Mcclatchy D.C.', 'Mcclatchy Dc', 'Meet The Press', 'Melinda Gates', 'Mental Health Counseling', 'Michael Flynn', 'Michigan', 'Microsoft', 'Migrants', 'Mike Pence', 'Military', 'Miriam Valverde', 'Misinformation', 'Mississippi', 'Mississippi Churchgoers', 'Missouri', 'Mitch Mcconnell', 'Mmr', 'Mobile Apps', 'Mobs', 'Money', 'Monthly', 'Mosques', 'My Account', 'N-95 Respirators', 'Nancy Pelosi', 'National Anthem', 'Natural Gas', 'Nbc', 'Net-Zero', 'Net-Zero Emissions', 'New York', 'New York Times', 'News', 'Newsletters', 'Newsroom', 'Newsrooms', 'Nextgen Climate Action Committee', 'North Carolina', 'Northwest Corridor Highway', 'Npr', 'Obama', 'Obameter', 'Oil', 'One Time', 'Online Prayers', 'Open Borders', 'Opinion', 'Our Process', 'Our Staff', 'Pandemic', 'Patients', 'Paul Manafort', 'Paul Specht', 'Pence', 'Pennsylvania', 'People', 'Pinterest', 'Places Of Worship', 'Plaintiffs', 'Plasma', 'Podcasts', 'Police', 'Police Funding', 'Polio', 'Poynter Institute', 'Preexisting Conditions', 'President', 'Press Releases', 'Promise Tracker', 'Quarantine', 'Rachel Maddow', 'Randy Feenstra', 'Readers', 'Reddit', 'Reform', 'Republican Convention',  'Republican Party Nomination', 'Republicans', 'Resolution', 'Respirators', 'Richard Grinell', 'Rick Barr', 'Rick Scott', 'Roads & Bridges', 'Ron Johnson', 'Rss', 'Rss Feeds', 'Rush Limbaugh', 'Russia', 'Samantha Putterman', 'Sean Hannity', 'Senate', 'Social', 'Social Distancing', 'Social Media Platforms', 'Socialism', 'Son', 'Soviet Union', 'Sports', 'State Governments', 'Stimulus Money', 'Tech', 'Testing', 'Texas', 'The City', 'The Daily Beast', 'Travel', 'Travel Restrictions', 'Trump', 'Trump Administration', 'Trump Campaign', 'Trump White House', 'Trusted Information', 'Truth', 'Truth Squad', 'Truth-O-Meter', 'Tucker Carlson', 'Tweet', 'Twitter', 'U.S.', 'U.S. Citizens', 'U.S. Government', 'United States', 'United States Bulk-Power System', 'Us Trafficking Arrests', 'Usa Today', 'User Policies', 'Utah', 'Vaccinations', 'Vaccine', 'Vaccines', 'Ventilators', 'Vermont', 'Victoria Knight', 'Virginia', 'Virus', 'Washington', 'Washington, D.C.', 'Washington, Dc', 'Wealthy', 'West Virginia', 'White House', 'Who', 'Who Meeting', 'William Barr', 'Willie Wilson', 'Wisconsin', 'Wisconsin Schools', 'World Health Organization', 'Wreg', 'Wreg Memphis', 'Wuhan', 'Xi Jinping', 'Yearly', 'You', 'Youtube'],
